	...
	<main class="container">
		...
		<div class="hall-main mt25">
			<div class="clanhall-letter-wrap clearfix">
				<div class="title">按姓氏首字母查找：</div>
				<ul class="letter-wrap js-letter-list">
					<c:forEach items="${entryMap }" var="item">
						<li><a href="javascript:void(0)" class="js-anchor-a" data-id="#anchor${item.key}">${item.key}</a></li>
					</c:forEach>
				</ul>
			</div>
									...
									<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 col">
										<div class="clanhall-item js-clanhall-item">
											<div class="pic js-clanhall-pic">
												...
												<div class="pic-enlarge js-pic-enlarge" style="display:none"><img class="js-clanhall-enlarge" src="" data-url="http://image.100citang.cn:9880/seo/${ itemValue.coverImage}"></div>
											</div>
											<div class="body">
